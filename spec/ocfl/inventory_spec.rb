...
RSpec.describe OCFL::Inventory do
  ...
  context "when object doesn't exist" do
    let(:data) do
      OCFL::Inventory::InventoryStruct.new(id: "md919gh6774", type: "https://ocfl.io/1.1/spec/#inventory",
                                           digestAlgorithm: "sha512", head: "v0", versions: {}, manifest: {})
    end
  ...
  context "when object exists" do
    let(:data) do
      OCFL::InventoryLoader.load(file_name).value!
    end
